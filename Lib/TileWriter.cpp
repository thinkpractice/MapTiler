...
GdalWriter::GdalWriter(std::string epsgFormat, std::string driverName, std::string fileExtension)
                :   GdalWriter(SpatialReference::FromEPSG(epsgFormat), driverName, fileExtension)
{
}
